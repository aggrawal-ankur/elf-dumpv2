...
# 1940 "/usr/include/elf.h" 3 4
typedef struct
{
  Elf32_Word hwp_flags1;
  Elf32_Word hwp_flags2;
} Elf_Options_Hw;
# 2166 "/usr/include/elf.h" 3 4
typedef struct
{
  Elf32_Word l_name;
...
# 5 "../main.c" 2
# 1 ".././dump_structure/dump.h" 1



# 1 ".././dump_structure/../core_api/parser.h" 1
# 5 ".././dump_structure/dump.h" 2
...
# 16 "../main.c" 3 4
           stderr
# 16 "../main.c"
                 , "  Error: `fopen()`: file can't be opened!\n");
    return -1;
  }
...
# 23 "../main.c" 3 4
           stderr
# 23 "../main.c"
                 , "  Error: `parse_elf()`: Failed to verify the ELF file.\n");
    return 1;
  }
...
# 30 "../main.c" 3 4
           stderr
# 30 "../main.c"
                 , "Error: `malloc` failed to allocate memory for `AccessELF`\n");
    return -1;
  }
...
# 37 "../main.c" 3 4
           stderr
# 37 "../main.c"
                 , "  Error: file headers can't be parsed!\n");
    return -1;
  }
...
# 44 "../main.c" 3 4
           stderr
# 44 "../main.c"
                 , "  Error: program headers can't be parsed!\n");
    return -1;
  }
...
# 51 "../main.c" 3 4
           stderr
# 51 "../main.c"
                 , "  Error: section headers can't be parsed!\n");
    return -1;
  }
...
# 58 "../main.c" 3 4
           stderr
# 58 "../main.c"
                 , "  Error: section header string table can not be parsed.\n");
    return -1;
  }
...
# 65 "../main.c" 3 4
           stderr
# 65 "../main.c"
                 , "Error: string table can not be parsed.\n");
    return -1;
  }
...
# 72 "../main.c" 3 4
           stderr
# 72 "../main.c"
                 , "Error: .symtab can not be parsed.\n");
    return -1;
  }
...
# 79 "../main.c" 3 4
           stderr
# 79 "../main.c"
                 , "Error: .dynsym can not be parsed.\n");
    return -1;
  }
...
# 86 "../main.c" 3 4
           stderr
# 86 "../main.c"
                 , "Error: .rela.* entries can not be parsed.\n");
    return -1;
  }
...
# 93 "../main.c" 3 4
           stderr
# 93 "../main.c"
                 , "  └─ Error: .dynstr entries can not be parsed.\n");
    return -1;
  }
...
# 100 "../main.c" 3 4
           stderr
# 100 "../main.c"
                 , "  └─ Error: .dynamic entries can not be parsed.\n");
    return -1;
  }
